<h1 align="center">
  <img src="img/Logo-devclub.PNG" width="140" alt="DevClub Logo"/>
  <br>
...
### 📖 Sobre o Projeto
O DevClub é uma recriação da área de membros da DevClub feita do zero com HTML, CSS e JavaScript. 
O objetivo é simular uma plataforma real de ensino com design imersivo, navegação por scroll em 1 página só e organização de conteúdo em 6 seções principais.
...
| --- | --- |
| <img src="https://img.shields.io/badge/HTML5-E34F26?style=for-the-badge&logo=html5&logoColor=white"> | Estrutura semântica do site. Organização das 6 seções: Home, Método, Aulas, Agenda, Comunidade, Vagas, Suporte |
| <img src="https://img.shields.io/badge/CSS3-1572B6?style=for-the-badge&logo=css3&logoColor=white"> | Tema Dark, design responsivo, animações, Flexbox e Grid. Criação da identidade visual futurista |
| <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black"> | Navegação por scroll suave, interatividade dos botões, menu fixo e filtros da Agenda de Eventos |
...
```bash
git clone https://github.com/alessandrofelix2607/DevClub
