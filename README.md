...
| :--- | :--- |
| ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat) | Estrutura semântica do site. Organização das 6 seções: Home, Aulas, Agenda, Comunidade, Vagas, Suporte |
| ![CSS3](https://img.shields.io/badge/CSS3-1572B6?style=flat) | Tema Dark, design responsivo, animações, Flexbox e Grid. Criação da identidade visual futurista |
| ![JAVASCRIPT](https://img.shields.io/badge/JAVASCRIPT-F7DF1E?style=flat) | Navegação por scroll suave, interatividade dos botões, menu fixo e filtros da Agenda de Eventos |
